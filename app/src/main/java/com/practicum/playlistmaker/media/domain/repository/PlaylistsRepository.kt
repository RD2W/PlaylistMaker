...
interface PlaylistsRepository {
     ...
     *
     * Логика работы:
     * 1. Выполняет SQL-запрос DELETE, который удаляет все записи из таблицы `playlist_track_cross_ref`,
     ...
     * 4. Треки (записи в таблице `tracks`) остаются в базе данных, так как они могут быть связаны с другими плейлистами.
     *
     * Особенности:
